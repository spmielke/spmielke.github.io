...
Projects contributing to this effort have, e.g., 1) demonstrated an empirical correlation between the averaged chemical shift (ACS) of protein backbone nuclei and observed secondary structure (&alpha;&#8209;helix and &beta;&#8209strand) content, as a fraction of overall conformation (Sibley, Monique, Krish); 2) confirmed these results by applying rigorous statistical methods (see Methods) to establish further correlations between ACS and protein structural classes (Mielke, Krishnan); and 3) extended foregoing results ... <ML> ... (..., Krishnan).  
